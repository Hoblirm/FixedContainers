...
namespace eastl
{
  ...
  public:
    ...
    EASTL_STRING_EXPLICIT basic_string(const value_type* p, const allocator_type& allocator = allocator_type());
    ...
    basic_string(const value_type* pBegin, const value_type* pEnd, const allocator_type& allocator = allocator_type());
