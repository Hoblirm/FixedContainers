...
public:
  ...
  enum : size_type
  { // Use Microsoft enum language extension, allowing for smaller debug symbols than using a static const. Users have been affected by this.
    npos = (size_type)-1,
...
public:
  ...
  basic_string(const value_type* p, size_type n, const allocator_type& allocator = allocator_type()); EASTL_STRING_EXPLICIT
  ...
  template<class InputIterator> basic_string(InputIterator pBegin, InputIterator pEnd, const allocator_type& allocator =
      allocator_type());
  ...
  // Iterators.
  iterator begin()
  EA_NOEXCEPT;                 // Expanded in source code as: mpBegin
  ...
  iterator end()
  EA_NOEXCEPT;                   // Expanded in source code as: mpEnd
  ...
  bool empty() const
  EA_NOEXCEPT;                // Expanded in source code as: (mpBegin == mpEnd) or (mpBegin != mpEnd)
  size_type size() const
  EA_NOEXCEPT;                 // Expanded in source code as: (size_type)(mpEnd - mpBegin)
  size_type length() const
  EA_NOEXCEPT;               // Expanded in source code as: (size_type)(mpEnd - mpBegin)
  size_type max_size() const
  EA_NOEXCEPT;             // Expanded in source code as: kMaxSize
  size_type capacity() const
  EA_NOEXCEPT; // Expanded in source code as: (size_type)((mpCapacity - mpBegin) - 1). Thus thus returns the max strlen the container can currently hold without resizing.
  ...
  static int comparei(const value_type* pBegin1, const value_type* pEnd1, const value_type* pBegin2,
      const value_type* pEnd2);
...
int Compare(const T* p1, const T* p2, size_t n)
{
  for (; n > 0; ++p1, ++p2, --n)
  {
    if (*p1 != *p2)
      return
          (static_cast<typename make_unsigned<T>::type>(*p1) < static_cast<typename make_unsigned<T>::type>(*p2)) ?
              -1 : 1;
  }
  return 0;
}
...
inline int CompareI(const T* p1, const T* p2, size_t n)
{
  for (; n > 0; ++p1, ++p2, --n)
  {
    ...
    if (c1 != c2)
      return
          (static_cast<typename make_unsigned<T>::type>(c1) < static_cast<typename make_unsigned<T>::type>(c2)) ? -1 : 1;
  }
  return 0;
}
...
inline basic_string<T, Allocator>::basic_string(CtorConvert, const OtherStringType& x) :
    mpBegin(NULL), mpEnd(NULL), mpCapacity(NULL), mAllocator(x.get_allocator())
{
  AllocateSelf();
    ...
    mpBegin(NULL), mpEnd(NULL), mpCapacity(NULL), mAllocator(x.mAllocator)
{
  ...
  RangeInitialize(x.mpBegin + position,
      x.mpBegin + position + eastl::min_alt(n, (size_type) (x.mpEnd - x.mpBegin) - position));
#endif
}
...
template<typename T, typename Allocator>
template<typename OtherCharType>
inline basic_string<T, Allocator>::basic_string(CtorConvert, const OtherCharType* p, size_type n,
...
template <typename T, typename Allocator>
inline typename basic_string<T, Allocator>::const_iterator
basic_string<T, Allocator>::cbegin() const
EA_NOEXCEPT
{
  return mpBegin;
}
...
template <typename T, typename Allocator>
inline typename basic_string<T, Allocator>::const_iterator
basic_string<T, Allocator>::cend() const
EA_NOEXCEPT
{
  return mpEnd;
}
...
template <typename T, typename Allocator>
inline typename basic_string<T, Allocator>::const_reverse_iterator
basic_string<T, Allocator>::crbegin() const
EA_NOEXCEPT
{
  return const_reverse_iterator(mpEnd);
}
...
template <typename T, typename Allocator>
inline typename basic_string<T, Allocator>::const_reverse_iterator
basic_string<T, Allocator>::crend() const
EA_NOEXCEPT
{
  return const_reverse_iterator(mpBegin);
}
...
template<typename T, typename Allocator>
basic_string<T, Allocator>& basic_string<T, Allocator>::append_sprintf_va_list(const value_type* pFormat,
    va_list arguments)
{
...
template<typename T, typename Allocator>
inline typename basic_string<T, Allocator>::iterator basic_string<T, Allocator>::insert(const_iterator p, value_type c)
{
  if (p == mpEnd)
  {
    push_back(c);
...
template<typename T, typename Allocator>
basic_string<T, Allocator>& basic_string<T, Allocator>::replace(const_iterator pBegin, const_iterator pEnd, size_type n,
    value_type c)
{
#if EASTL_ASSERT_ENABLED
  if(EASTL_UNLIKELY((pBegin < mpBegin) || (pBegin > mpEnd) || (pEnd < mpBegin) || (pEnd > mpEnd) || (pEnd < pBegin)))
    ...
    const value_type* pBegin2, const value_type* pEnd2)
{
  ...
  else // Else we are expanding.
  {
    ...
    else // else we have an overlapping operation.
    {
      ...
      const size_type nOldSize = (size_type) (mpEnd - mpBegin);
      const size_type nOldCap = (size_type) ((mpCapacity - mpBegin) - 1);
      const size_type nNewCapacity = eastl::max_alt((size_type) GetNewCapacity(nOldCap),
...
template <typename T, typename Allocator>
inline typename basic_string<T, Allocator>::size_type
basic_string<T, Allocator>::find(const this_type& x, size_type position) const
EA_NOEXCEPT
{
...
template<typename T, typename Allocator>
typename basic_string<T, Allocator>::size_type basic_string<T, Allocator>::find(const value_type* p, size_type position,
    size_type n) const
{
...
template <typename T, typename Allocator>
inline typename basic_string<T, Allocator>::size_type
basic_string<T, Allocator>::rfind(const this_type& x, size_type position) const
EA_NOEXCEPT
{
...
template <typename T, typename Allocator>
inline typename basic_string<T, Allocator>::size_type
basic_string<T, Allocator>::find_first_of(const this_type& x, size_type position) const
EA_NOEXCEPT
{
...
template <typename T, typename Allocator>
inline typename basic_string<T, Allocator>::size_type
basic_string<T, Allocator>::find_last_of(const this_type& x, size_type position) const
EA_NOEXCEPT
{
...
template <typename T, typename Allocator>
inline typename basic_string<T, Allocator>::size_type
basic_string<T, Allocator>::find_first_not_of(const this_type& x, size_type position) const
EA_NOEXCEPT
{
...
template<typename T, typename Allocator>
inline typename basic_string<T, Allocator>::size_type basic_string<T, Allocator>::find_first_not_of(const value_type* p,
    size_type position) const
{
...
template <typename T, typename Allocator>
inline typename basic_string<T, Allocator>::size_type
basic_string<T, Allocator>::find_last_not_of(const this_type& x, size_type position) const
EA_NOEXCEPT
{
...
template<typename T, typename Allocator>
inline typename basic_string<T, Allocator>::size_type basic_string<T, Allocator>::find_last_not_of(const value_type* p,
    size_type position) const
{
...
inline basic_string<T, Allocator> basic_string<T, Allocator>::substr(size_type position, size_type n) const
{
  ...
  return basic_string(mpBegin + position,
      mpBegin + position + eastl::min_alt(n, (size_type) (mpEnd - mpBegin) - position), mAllocator);
}

template <typename T, typename Allocator>
inline int basic_string<T, Allocator>::compare(const this_type& x) const
EA_NOEXCEPT
{
...
inline int basic_string<T, Allocator>::compare(size_type pos1, size_type n1, const this_type& x) const
{
  ...
  return compare(mpBegin + pos1, mpBegin + pos1 + eastl::min_alt(n1, (size_type) (mpEnd - mpBegin) - pos1), x.mpBegin,
      x.mpEnd);
}
    ...
    size_type n2) const
{
  ...
  return compare(mpBegin + pos1, mpBegin + pos1 + eastl::min_alt(n1, (size_type) (mpEnd - mpBegin) - pos1),
      x.mpBegin + pos2, x.mpBegin + pos2 + eastl::min_alt(n2, (size_type) (x.mpEnd - x.mpBegin) - pos2));
}
...
inline int basic_string<T, Allocator>::compare(size_type pos1, size_type n1, const value_type* p) const
{
  ...
  return compare(mpBegin + pos1, mpBegin + pos1 + eastl::min_alt(n1, (size_type) (mpEnd - mpBegin) - pos1), p,
      p + CharStrlen(p));
}
...
inline int basic_string<T, Allocator>::compare(size_type pos1, size_type n1, const value_type* p, size_type n2) const
{
  ...
  return compare(mpBegin + pos1, mpBegin + pos1 + eastl::min_alt(n1, (size_type) (mpEnd - mpBegin) - pos1), p, p + n2);
}
...
template<typename T, typename Allocator>
int basic_string<T, Allocator>::comparei(const value_type* pBegin1, const value_type* pEnd1, const value_type* pBegin2,
    const value_type* pEnd2)
{
  const ptrdiff_t n1 = pEnd1 - pBegin1;
  const ptrdiff_t n2 = pEnd2 - pBegin2;
...
template <typename T, typename Allocator>
inline int basic_string<T, Allocator>::comparei(const this_type& x) const
EA_NOEXCEPT
{
...
template<typename T, typename Allocator>
typename basic_string<T, Allocator>::iterator basic_string<T, Allocator>::InsertInternal(const_iterator p, value_type c)
{
    ...
    const basic_string<T, Allocator>& b)
{
  typedef typename basic_string<T, Allocator>::CtorDoNotInitialize CtorDoNotInitialize;
  CtorDoNotInitialize cDNI; // GCC 2.x forces us to declare a named temporary like this.
  const typename basic_string<T, Allocator>::size_type n = (typename basic_string<T, Allocator>::size_type) CharStrlen(
      p);
