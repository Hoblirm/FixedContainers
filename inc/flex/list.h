...
namespace flex
{
  ...
  public:
    ...
    //TODO: clear method missing, may want to consider adding other methods like shrink_to_size as well
    iterator begin();
  ...
  inline typename list<T, Alloc>::iterator list<T, Alloc>::insert(iterator position, const_reference val)
  {
    ...
    node_type* new_node = DoRetrieveNode();
    ++mSize;
