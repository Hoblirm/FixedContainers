...
#ifndef FLEX_INTERNAL_HASHTABLE_H
#define FLEX_INTERNAL_HASHTABLE_H

#include <flex/internal/type_traits.h>
#include <flex/internal/functional.h>
#include <flex/internal/algorithm.h>
...
namespace flex
{
   ...
   ///
   static void* gpEmptyBucketArray[2] = {NULL, (void*) uintptr_t(~0)};
   ...
   ///
   static const uint32_t gPrimeNumberArray[] = {2u, 3u, 5u, 7u, 11u, 13u, 17u, 19u, 23u, 29u, 31u, 37u, 41u, 43u, 47u,
      53u, 59u, 61u, 67u, 71u, 73u, 79u, 83u, 89u, 97u, 103u, 109u, 113u, 127u, 137u, 139u, 149u, 157u, 167u, 179u,
      193u, 199u, 211u, 227u, 241u, 257u, 277u, 293u, 313u, 337u, 359u, 383u, 409u, 439u, 467u, 503u, 541u, 577u, 619u,
      661u, 709u, 761u, 823u, 887u, 953u, 1031u, 1109u, 1193u, 1289u, 1381u, 1493u, 1613u, 1741u, 1879u, 2029u, 2179u,
      2357u, 2549u, 2753u, 2971u, 3209u, 3469u, 3739u, 4027u, 4349u, 4703u, 5087u, 5503u, 5953u, 6427u, 6949u, 7517u,
      8123u, 8783u, 9497u, 10273u, 11113u, 12011u, 12983u, 14033u, 15173u, 16411u, 17749u, 19183u, 20753u, 22447u,
      24281u, 26267u, 28411u, 30727u, 33223u, 35933u, 38873u, 42043u, 45481u, 49201u, 53201u, 57557u, 62233u, 67307u,
      72817u, 78779u, 85229u, 92203u, 99733u, 107897u, 116731u, 126271u, 136607u, 147793u, 159871u, 172933u, 187091u,
      202409u, 218971u, 236897u, 256279u, 277261u, 299951u, 324503u, 351061u, 379787u, 410857u, 444487u, 480881u,
      520241u, 562841u, 608903u, 658753u, 712697u, 771049u, 834181u, 902483u, 976369u, 1056323u, 1142821u, 1236397u,
      1337629u, 1447153u, 1565659u, 1693859u, 1832561u, 1982627u, 2144977u, 2320627u, 2510653u, 2716249u, 2938679u,
      3179303u, 3439651u, 3721303u, 4026031u, 4355707u, 4712381u, 5098259u, 5515729u, 5967347u, 6456007u, 6984629u,
      7556579u, 8175383u, 8844859u, 9569143u, 10352717u, 11200489u, 12117689u, 13109983u, 14183539u, 15345007u,
      16601593u, 17961079u, 19431899u, 21023161u, 22744717u, 24607243u, 26622317u, 28802401u, 31160981u, 33712729u,
      36473443u, 39460231u, 42691603u, 46187573u, 49969847u, 54061849u, 58488943u, 63278561u, 68460391u, 74066549u,
      80131819u, 86693767u, 93793069u, 101473717u, 109783337u, 118773397u, 128499677u, 139022417u, 150406843u,
      162723577u, 176048909u, 190465427u, 206062531u, 222936881u, 241193053u, 260944219u, 282312799u, 305431229u,
      330442829u, 357502601u, 386778277u, 418451333u, 452718089u, 489790921u, 529899637u, 573292817u, 620239453u,
      671030513u, 725980837u, 785430967u, 849749479u, 919334987u, 994618837u, 1076067617u, 1164186217u, 1259520799u,
   ...
   ///
#define FLEX_MACRO_SWAP(Type, a, b) \
   ...
   struct equal_to_2 : public std::binary_function<T, U, bool>
   {
   ...
   template<typename T>
   struct equal_to_2<T, T> : public std::equal_to<T>
   {
   };
   ...
   inline typename std::iterator_traits<Iterator>::difference_type distance_fw_impl(Iterator /*first*/,
           Iterator /*last*/, std::input_iterator_tag)
   {
      return 0;
   }

   template<typename Iterator>
   inline typename std::iterator_traits<Iterator>::difference_type distance_fw_impl(Iterator first, Iterator last,
   ...
   template<typename Iterator>
   inline typename std::iterator_traits<Iterator>::difference_type ht_distance(Iterator first, Iterator last)
   {
   ...
   public:
      ...
      std::pair<bool, uint32_t > GetRehashRequired(uint32_t nBucketCount, uint32_t nElementCount,
              uint32_t nElementAdd) const
      {
         if ((nElementCount + nElementAdd) > mnNextResize) // It is significant that we specify > next resize and not >= next resize.
         {
            ...
            {
               fMinBucketCount = std::max(fMinBucketCount, mfGrowthFactor * nBucketCount);
               const uint32_t nPrime = *std::lower_bound(gPrimeNumberArray, gPrimeNumberArray + kPrimeCount,
   ...
   hashtable<Key, Value, Allocator, ExtractKey, Equal, H1, H2, H, RehashPolicy, bCacheHashCode, bMutableIterators,
   bUniqueKeys> >, public hash_code_base<Key, Value, ExtractKey, Equal, H1, H2, H, bCacheHashCode>
   {
   public:
      ...
      typedef hashtable<Key, Value, Allocator, ExtractKey, Equal, H1, H2, H, RehashPolicy, bCacheHashCode,
      bMutableIterators, bUniqueKeys> this_type;
      ...
      enum
      {
         // This enumeration is deprecated in favor of flex::kHashtableAllocFlagBuckets.
         kAllocFlagBuckets = flex::kHashtableAllocFlagBuckets // Flag to allocator which indicates that we are allocating buckets and not nodes.
      };
   ...
   public:
      ...
      local_iterator begin(size_type n) FLEX_NOEXCEPT
      {
         return local_iterator(mpBucketArray[n]);
      }

      const_local_iterator begin(size_type n) const FLEX_NOEXCEPT
      {
         return const_local_iterator(mpBucketArray[n]);
      }

      const_local_iterator cbegin(size_type n) const FLEX_NOEXCEPT
      {
         return const_local_iterator(mpBucketArray[n]);
      }
      ...
      local_iterator end(size_type) FLEX_NOEXCEPT
      {
         return local_iterator(NULL);
      }

      const_local_iterator end(size_type) const FLEX_NOEXCEPT
      {
         return const_local_iterator(NULL);
      }

      const_local_iterator cend(size_type) const FLEX_NOEXCEPT
      {
         return const_local_iterator(NULL);
      }

      bool empty() const FLEX_NOEXCEPT
      {
      ...
      size_type bucket_count() const FLEX_NOEXCEPT
      {
         return mnBucketCount;
      }

      size_type bucket_size(size_type n) const FLEX_NOEXCEPT
      {
   ...
   public:
      ...
      float load_factor() const FLEX_NOEXCEPT
      {
      ...
      const rehash_policy_type& rehash_policy() const FLEX_NOEXCEPT
      {
   ...
   public:
      ...
      size_type count(const key_type& k) const FLEX_NOEXCEPT;
   ...
   protected:
      ...
      iterator DoGetResultIterator(std::true_type, const insert_return_type& irt) const FLEX_NOEXCEPT
      {
         return irt.first;
      }

      iterator DoGetResultIterator(std::false_type, const insert_return_type& irt) const FLEX_NOEXCEPT
      {
         return irt;
      }
...
#ifdef FLEX_HAS_CXX11
      std::pair<iterator, bool> DoInsertValueExtra(std::true_type, const key_type& k, hash_code_t c, node_type* pNodeNew, value_type && value);
      std::pair<iterator, bool> DoInsertValue(std::true_type, value_type && value);
      iterator DoInsertValueExtra(std::false_type, const key_type& k, hash_code_t c, node_type* pNodeNew, value_type && value);
      iterator DoInsertValue(std::false_type, value_type && value);
      node_type* DoAllocateNode(value_type && value);
#endif

      std::pair<iterator, bool> DoInsertValueExtra(std::true_type, const key_type& k, hash_code_t c, node_type* pNodeNew,
              const value_type& value);
      std::pair<iterator, bool> DoInsertValue(std::true_type, const value_type& value);
      iterator DoInsertValueExtra(std::false_type, const key_type& k, hash_code_t c, node_type* pNodeNew,
              const value_type& value);
      iterator DoInsertValue(std::false_type, const value_type& value);
      node_type* DoAllocateNode(const value_type& value);

      void DoFillNodePool(size_type n);
      void DoPushToNodePool(node_type* ptr);
      void DoPurgeNodePool();
   ...
   hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::hashtable(size_type nBucketCount, const H1& h1, const H2& h2,
           const H& h, const Eq& eq, const EK& ek, const allocator_type& allocator) :
   rehash_base<RP, hashtable>(), hash_code_base<K, V, EK, Eq, H1, H2, H, bC>(ek, eq, h1, h2, h), mnBucketCount(0), mnElementCount(
   0), mRehashPolicy(), mAllocator(allocator), mNodePool(NULL), mFixedBegin(NULL), mFixedEnd(NULL), mFixed(false), mOverflow(false)
   {
   ...
   typename RP, bool bC, bool bM, bool bU>
   template<typename FowardIterator>
   hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::hashtable(FowardIterator first, FowardIterator last,
           size_type nBucketCount, const H1& h1, const H2& h2, const H& h, const Eq& eq, const EK& ek,
           const allocator_type& allocator) :
   rehash_base<rehash_policy_type, hashtable>(), hash_code_base<key_type, value_type, extract_key_type, key_equal,
   h1_type, h2_type, h_type, kCacheHashCode>(ek, eq, h1, h2, h),
   //mnBucketCount(0), // This gets re-assigned below.
   mnElementCount(0), mRehashPolicy(), mAllocator(allocator), mNodePool(NULL), mFixedBegin(NULL), mFixedEnd(NULL), mFixed(false), mOverflow(false)
   {
      if (nBucketCount < 2)
      {
         const size_type nElementCount = (size_type) flex::ht_distance(first, last);
   ...
   rehash_base<RP, hashtable>(x), hash_code_base<K, V, EK, Eq, H1, H2, H, bC>(x), mnBucketCount(x.mnBucketCount), mnElementCount(
   x.mnElementCount), mRehashPolicy(x.mRehashPolicy), mAllocator(x.mAllocator), mNodePool(NULL), mFixedBegin(NULL), mFixedEnd(NULL), mFixed(false), mOverflow(false)
   {
   ...
   mAllocator(x.mAllocator), mNodePool(NULL), mFixedBegin(NULL), mFixedEnd(NULL), mFixed(false), mOverflow(false)
   {
   ...
   mnElementCount(0),
   mRehashPolicy(x.mRehashPolicy),
   mAllocator(allocator), mNodePool(NULL), mFixedBegin(NULL), mFixedEnd(NULL), mFixed(false), mOverflow(false)
   {
      reset_lose_memory(); // We do this here the same as we do it in the default ctor because it puts the container in a proper initial empty state. This code would be cleaner if we could rely on being able to use C++11 delegating constructors and just call the default ctor here.
   ...
   hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::get_allocator() const FLEX_NOEXCEPT
   {
      return mAllocator;
   }
   ...
   hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::get_allocator() FLEX_NOEXCEPT
   {
      return mAllocator;
   }
           ...
           size_type n)
   {
      ...
      if (n > 1)
         mAllocator.deallocate((char*) pBucketArray, (n + 1) * sizeof (node_type*));
   }
   ...
   inline void hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::swap(this_type& x)
   {
      if (mAllocator == x.mAllocator) // If allocators are equivalent...
      {
         ...
         FLEX_MACRO_SWAP(node_type**, mpBucketArray, x.mpBucketArray); // Use FLEX_MACRO_SWAP because GCC (at least v4.6-4.8) has a bug where it fails to compile eastl::swap(mpBucketArray, x.mpBucketArray).
   ...
   template<typename K, typename V, typename A, typename EK, typename Eq, typename H1, typename H2, typename H,
   typename RP, bool bC, bool bM, bool bU>
   inline typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator hashtable<K, V, A, EK, Eq, H1, H2, H,
   RP, bC, bM, bU>::find(const key_type& k)
   {
   ...
   template<typename K, typename V, typename A, typename EK, typename Eq, typename H1, typename H2, typename H,
   typename RP, bool bC, bool bM, bool bU>
   inline typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::const_iterator hashtable<K, V, A, EK, Eq, H1,
   H2, H, RP, bC, bM, bU>::find(const key_type& k) const
   {
      const hash_code_t c = get_hash_code(k);
      const size_type n = (size_type) bucket_index(k, c, (uint32_t) mnBucketCount);
   ...
   template<typename U, typename UHash, typename BinaryPredicate>
   inline typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator hashtable<K, V, A, EK, Eq, H1, H2, H,
   RP, bC, bM, bU>::find_as(const U& other, UHash uhash, BinaryPredicate predicate)
   {
   ...
   template<typename U, typename UHash, typename BinaryPredicate>
   inline typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::const_iterator hashtable<K, V, A, EK, Eq, H1,
   H2, H, RP, bC, bM, bU>::find_as(const U& other, UHash uhash, BinaryPredicate predicate) const
   {
      const hash_code_t c = (hash_code_t) uhash(other);
      const size_type n = (size_type) (c % mnBucketCount); // This assumes we are using the mod range policy.
   ...
   {
      return hashTable.find_as(u, std::hash<U > (), flex::equal_to_2<const typename H::key_type, U > ());
   }
   ...
   template<typename U>
   inline typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator hashtable<K, V, A, EK, Eq, H1, H2, H,
   RP, bC, bM, bU>::find_as(const U& other)
   {
      return flex::hashtable_find(*this, other);
   }
   ...
   //{ return find_as(other, std::hash<U>(), flex::equal_to_2<const key_type, U>()); }

   template<typename K, typename V, typename A, typename EK, typename Eq, typename H1, typename H2, typename H,
   typename RP, bool bC, bool bM, bool bU>
   template<typename U>
   inline typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::const_iterator hashtable<K, V, A, EK, Eq, H1,
   H2, H, RP, bC, bM, bU>::find_as(const U& other) const
   {
      return flex::hashtable_find(*this, other);
   }
   // VC++ doesn't appear to like the following, though it seems correct to me.
   ...
   typename RP, bool bC, bool bM, bool bU>
   inline typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator hashtable<K, V, A, EK, Eq, H1, H2, H,
   RP, bC, bM, bU>::find_by_hash(hash_code_t c)
   {
      FLEX_ERROR_MSG_IF(bC, "find_by_hash(hash_code_t c) is designed to avoid recomputing hashes, "
   ...
   typename RP, bool bC, bool bM, bool bU>
   inline typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::const_iterator hashtable<K, V, A, EK, Eq, H1,
   H2, H, RP, bC, bM, bU>::find_by_hash(hash_code_t c) const
   {
      FLEX_ERROR_MSG_IF(bC, "find_by_hash(hash_code_t c) is designed to avoid recomputing hashes, "
              "so it requires cached hash codes.  Consider setting template parameter "
              "bCacheHashCode to true or using find_by_hash(const key_type& k, hash_code_t c) instead.");
   ...
   typename RP, bool bC, bool bM, bool bU>
   inline typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator hashtable<K, V, A, EK, Eq, H1, H2, H,
   RP, bC, bM, bU>::find_by_hash(const key_type& k, hash_code_t c)
   {
      const size_type n = (size_type) bucket_index(c, (uint32_t) mnBucketCount);
   ...
   typename RP, bool bC, bool bM, bool bU>
   inline typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::const_iterator hashtable<K, V, A, EK, Eq, H1,
   H2, H, RP, bC, bM, bU>::find_by_hash(const key_type& k, hash_code_t c) const
   {
      const size_type n = (size_type) bucket_index(c, (uint32_t) mnBucketCount);
   ...
   typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::const_iterator> hashtable<K, V, A, EK, Eq, H1, H2,
   H, RP, bC, bM, bU>::find_range_by_hash(hash_code_t c) const
   {
   ...
   typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator> hashtable<K, V, A, EK, Eq, H1, H2, H,
   RP, bC, bM, bU>::find_range_by_hash(hash_code_t c)
   {
      const size_type start = (size_type) bucket_index(c, (uint32_t) mnBucketCount);
      node_type * const pNodeStart = mpBucketArray[start];
   ...
   template<typename K, typename V, typename A, typename EK, typename Eq, typename H1, typename H2, typename H,
   typename RP, bool bC, bool bM, bool bU>
   typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::size_type hashtable<K, V, A, EK, Eq, H1, H2, H, RP,
   bC, bM, bU>::count(const key_type& k) const FLEX_NOEXCEPT
   {
      const hash_code_t c = get_hash_code(k);
      const size_type n = (size_type) bucket_index(k, c, (uint32_t) mnBucketCount);
      size_type result = 0;
   ...
   std::pair<typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator,
   typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator> hashtable<K, V, A, EK, Eq, H1, H2, H,
   RP, bC, bM, bU>::equal_range(const key_type& k)
   {
      const hash_code_t c = get_hash_code(k);
      const size_type n = (size_type) bucket_index(k, c, (uint32_t) mnBucketCount);
   ...
   std::pair<typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::const_iterator,
   typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::const_iterator> hashtable<K, V, A, EK, Eq, H1, H2,
   H, RP, bC, bM, bU>::equal_range(const key_type& k) const
   {
      const hash_code_t c = get_hash_code(k);
      const size_type n = (size_type) bucket_index(k, c, (uint32_t) mnBucketCount);
      node_type** head = mpBucketArray + n;
   ...
   typename RP, bool bC, bool bM, bool bU>
   inline typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::node_type*
   hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoFindNode(node_type* pNode, const key_type& k,
           hash_code_t c) const
   {
   ...
   template<typename U, typename BinaryPredicate>
   inline typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::node_type*
   hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoFindNodeT(node_type* pNode, const U& other,
   ...
   hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoInsertValue(std::true_type, Args && ... args) // std::true_type means bUniqueKeys is true.
   {
      ...
      if (pNode == NULL)// If value is not present... add it.
      {
         ...
         try
         {
            ...
            FLEX_ASSERT((uintptr_t) mpBucketArray != (uintptr_t) & gpEmptyBucketArray[0]);
      ...
      else
      {
         ...
         // the node. One possible resolution is to create specializations: DoInsertValue(std::true_type, value_type&&) and
         // DoInsertValue(std::true_type, const value_type&) which don't need to create a node up front in order to get the
   ...
   hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoInsertValue(std::false_type, Args && ... args) // std::false_type means bUniqueKeys is false.
   {
      const std::pair<bool, uint32_t> bRehash = mRehashPolicy.GetRehashRequired((uint32_t) mnBucketCount, (uint32_t) mnElementCount, (uint32_t) 1);
      ...
      if (pNodePrev == NULL)
      {
         FLEX_ASSERT((void**) mpBucketArray != &gpEmptyBucketArray[0]);
         pNodeNew->mpNext = mpBucketArray[n];
         mpBucketArray[n] = pNodeNew;
      }
      else
   ...
   typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
   std::pair<typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator, bool>
   hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoInsertValueExtra(std::true_type, const key_type& k, hash_code_t c, node_type* pNodeNew, value_type && value) // std::true_type means bUniqueKeys is true.
   {
      // Adds the value to the hash table if not already present.
      // If already present then the existing value is returned via an iterator/bool pair.
      size_type n = (size_type) bucket_index(k, c, (uint32_t) mnBucketCount);
      ...
      if (pNode == NULL)// If value is not present... add it.
      {
         ...
         if (pNodeNew)
         {
            ::new((void*) &pNodeNew->mValue) value_type(std::move(value)); // It's expected that pNodeNew was allocated with allocate_uninitialized_node.
#ifndef FLEX_RELEASE
            nodeAllocated = false;
#endif
         }
   ...
   typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
   std::pair<typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator, bool>
   hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoInsertValue(std::true_type, value_type && value) // std::true_type means bUniqueKeys is true.
   {
      const key_type& k = mExtractKey(value);
      const hash_code_t c = get_hash_code(k);

      return DoInsertValueExtra(std::true_type(), k, c, NULL, std::move(value));
   }

   template <typename K, typename V, typename A, typename EK, typename Eq,
   typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
   typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator
   hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoInsertValueExtra(std::false_type, const key_type& k, hash_code_t c, node_type* pNodeNew, value_type && value) // std::false_type means bUniqueKeys is false.
   {
      const std::pair<bool, uint32_t> bRehash = mRehashPolicy.GetRehashRequired((uint32_t) mnBucketCount, (uint32_t) mnElementCount, (uint32_t) 1);
   ...
   typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
   typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator
   hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoInsertValue(std::false_type, value_type && value) // std::false_type means bUniqueKeys is false.
   {
      const key_type& k = mExtractKey(value);
      const hash_code_t c = get_hash_code(k);

      return DoInsertValueExtra(std::false_type(), k, c, NULL, std::move(value));
   }
   ...
   template<typename K, typename V, typename A, typename EK, typename Eq, typename H1, typename H2, typename H,
   typename RP, bool bC, bool bM, bool bU>
   std::pair<typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator, bool> hashtable<K, V, A, EK, Eq,
   H1, H2, H, RP, bC, bM, bU>::DoInsertValueExtra(std::true_type, const key_type& k, hash_code_t c,
           node_type* pNodeNew, const value_type& value) // std::true_type means bUniqueKeys is true.
   {
      // Adds the value to the hash table if not already present.
      // If already present then the existing value is returned via an iterator/bool pair.
      size_type n = (size_type) bucket_index(k, c, (uint32_t) mnBucketCount);
      ...
      if (pNode == NULL) // If value is not present... add it.
      {
         const std::pair<bool, uint32_t> bRehash = mRehashPolicy.GetRehashRequired((uint32_t) mnBucketCount,
                 (uint32_t) mnElementCount, (uint32_t) 1);
   ...
   typename RP, bool bC, bool bM, bool bU>
   std::pair<typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator, bool> hashtable<K, V, A, EK, Eq,
   H1, H2, H, RP, bC, bM, bU>::DoInsertValue(std::true_type, const value_type& value) // std::true_type means bUniqueKeys is true.
   {
      const key_type& k = mExtractKey(value);
      const hash_code_t c = get_hash_code(k);

      return DoInsertValueExtra(std::true_type(), k, c, NULL, value);
   }

   template<typename K, typename V, typename A, typename EK, typename Eq, typename H1, typename H2, typename H,
   typename RP, bool bC, bool bM, bool bU>
   typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC,
   bM, bU>::DoInsertValueExtra(std::false_type, const key_type& k, hash_code_t c, node_type* pNodeNew,
           const value_type& value) // std::false_type means bUniqueKeys is false.
   {
      const std::pair<bool, uint32_t> bRehash = mRehashPolicy.GetRehashRequired((uint32_t) mnBucketCount,
              (uint32_t) mnElementCount, (uint32_t) 1);
   ...
   typename RP, bool bC, bool bM, bool bU>
   typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC,
   bM, bU>::DoInsertValue(std::false_type, const value_type& value) // std::true_type means bUniqueKeys is true.
   {
      const key_type& k = mExtractKey(value);
      const hash_code_t c = get_hash_code(k);

      return DoInsertValueExtra(std::false_type(), k, c, NULL, value);
   }
   ...
   void hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::free_uninitialized_node(node_type* pNode)
   {
      ...
      pNode->mpNext = mNodePool;
      mNodePool = pNode;
   }

   template<typename K, typename V, typename A, typename EK, typename Eq, typename H1, typename H2, typename H,
   typename RP, bool bC, bool bM, bool bU>
   void hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoFillNodePool(size_type n)
   {
      for (; n; --n)
      {
   ...
   template<typename K, typename V, typename A, typename EK, typename Eq, typename H1, typename H2, typename H,
   typename RP, bool bC, bool bM, bool bU>
   void hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoPushToNodePool(node_type* pNode)
   {
   ...
   template<typename K, typename V, typename A, typename EK, typename Eq, typename H1, typename H2, typename H,
   typename RP, bool bC, bool bM, bool bU>
   void hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoPurgeNodePool(void)
   {
   ...
   typename RP, bool bC, bool bM, bool bU>
   std::pair<typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator, bool> hashtable<K, V, A, EK, Eq,
   H1, H2, H, RP, bC, bM, bU>::DoInsertKey(std::true_type, const key_type& key) // std::true_type means bUniqueKeys is true.
   {
   ...
   typename RP, bool bC, bool bM, bool bU>
   typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC,
   bM, bU>::DoInsertKey(std::false_type, const key_type& key) // std::false_type means bUniqueKeys is false.
   {
      const std::pair<bool, uint32_t> bRehash = mRehashPolicy.GetRehashRequired((uint32_t) mnBucketCount,
              (uint32_t) mnElementCount, (uint32_t) 1);
   ...
   template<typename K, typename V, typename A, typename EK, typename Eq, typename H1, typename H2, typename H,
   typename RP, bool bC, bool bM, bool bU>
   typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert_return_type hashtable<K, V, A, EK, Eq, H1, H2,
   H, RP, bC, bM, bU>::insert(const value_type& value)
   {
   ...
   typename RP, bool bC, bool bM, bool bU>
   typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert_return_type hashtable<K, V, A, EK, Eq, H1, H2,
   H, RP, bC, bM, bU>::insert(hash_code_t c, node_type* pNodeNew, const value_type& value)
   {
      // pNodeNew->mValue is expected to be uninitialized.
      const key_type& k = mExtractKey(value);
   ...
   typename RP, bool bC, bool bM, bool bU>
   typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC,
   bM, bU>::insert(const_iterator, const value_type& value)
   {
   ...
   {
      const uint32_t nElementAdd = (uint32_t) flex::ht_distance(first, last);
      const std::pair<bool, uint32_t> bRehash = mRehashPolicy.GetRehashRequired((uint32_t) mnBucketCount,
              (uint32_t) mnElementCount, nElementAdd);
   ...
   typename RP, bool bC, bool bM, bool bU>
   inline typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator hashtable<K, V, A, EK, Eq, H1, H2, H,
   RP, bC, bM, bU>::erase(const_iterator first, const_iterator last)
   {
      while (first != last)
         first = erase(first);
   ...
   typename RP, bool bC, bool bM, bool bU>
   typename hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::size_type hashtable<K, V, A, EK, Eq, H1, H2, H, RP,
   bC, bM, bU>::erase(const key_type& k)
   {
   ...
   template<typename K, typename V, typename A, typename EK, typename Eq, typename H1, typename H2, typename H,
   typename RP, bool bC, bool bM, bool bU>
   inline void hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::reset_lose_memory() FLEX_NOEXCEPT
   {
   ...
   template<typename K, typename V, typename A, typename EK, typename Eq, typename H1, typename H2, typename H,
   typename RP, bool bC, bool bM, bool bU>
   inline void hashtable<K, V, A, EK, Eq, H1, H2, H, RP, bC, bM, bU>::shrink_to_fit()
   {
      if (!mFixed)
      {
         DoPurgeNodePool();
