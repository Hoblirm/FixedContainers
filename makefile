...
cxx11:
	${CXXTEST_HOME}/bin/cxxtestgen --error-printer -o ./test/src/test.cpp ${TEST_FILES}
	g++ -std=c++11 -g -w -Wall -o ./test/bin/test_bin ./test/src/test.cpp -I./inc -I./ -I../EASTL/include -I../EASTL/test/packages/EABase/include/Common -I./test/inc -I${CXXTEST_HOME}
	./test/bin/test_bin
cxx_all:
	${CXXTEST_HOME}/bin/cxxtestgen --error-printer -o ./test/src/test.cpp ${TEST_FILES} 
